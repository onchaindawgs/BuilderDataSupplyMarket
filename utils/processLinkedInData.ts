...
function extractDeveloperPersona(profileData: any): DeveloperPersona {
  ...
  const keyTechnologies = [
    ...
    'python', 'javascript', 'typescript', 'java', 'kotlin', 'swift', 'ruby', 'go', 'rust', 'c++', 'c#', 'php', 'scala', 'dart',
    
    // Web Technologies
    'react', 'angular', 'vue', 'nodejs', 'express', 'django', 'flask', 'spring', 'laravel', 'ruby on rails',
    
    // Mobile Development
    'android', 'ios', 'flutter', 'react native', 'xamarin', 'ionic', 'kotlin multiplatform',
    
    // Cloud & DevOps
    'aws', 'azure', 'gcp', 'docker', 'kubernetes', 'terraform', 'jenkins', 'gitlab', 'github actions', 'ci/cd',
    
    // Databases
    'mongodb', 'postgresql', 'mysql', 'sqlite', 'redis', 'cassandra', 'dynamodb', 'oracle',
    
    // Machine Learning & AI
    'tensorflow', 'pytorch', 'keras', 'scikit-learn', 'pandas', 'numpy', 'machine learning', 'deep learning', 'ai',
    
    // Blockchain & Web3
    'blockchain', 'solidity', 'web3', 'smart contract', 'ethereum', 'dapp', 'decentralized',
    
    // Frontend
    'html5', 'css3', 'sass', 'less', 'tailwind', 'bootstrap', 'webpack', 'redux',
    
    // Backend
    'graphql', 'rest api', 'microservices', 'grpc', 'serverless',
    
    // Testing
    'jest', 'mocha', 'selenium', 'junit', 'pytest', 'cypress',
    
    // Other Frameworks & Tools
    'git', 'linux', 'shell scripting', 'agile', 'scrum', 'microservices', 'design patterns'
  ];
  ...
  const calculateExperience = (experiences: any[]): number => {
    return experiences.reduce((total, exp) => {
      ...
      const months = duration.includes('months') ? parseInt(duration[0]) / 12 : 0;
